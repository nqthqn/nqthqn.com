...
var author$project$Shared$UpdateDaysLeft = function (a) {
	return {$: 'UpdateDaysLeft', a: a};
};
var author$project$Days$Day = F2(
	function (allowance, transactions) {
		return {allowance: allowance, transactions: transactions};
	});
...
var author$project$Days$build = F2(
	function (length, allowance) {
		return A3(
			miyamoen$select_list$SelectList$fromLists,
			_List_Nil,
			A2(author$project$Days$Day, allowance, _List_Nil),
			A2(
				elm$core$List$repeat,
				length - 1,
				A2(author$project$Days$Day, allowance, _List_Nil)));
	});
var author$project$Shared$Begin = {$: 'Begin'};
var author$project$Shared$emptyModel = {
	currentPage: author$project$Shared$Begin,
	days: A2(author$project$Days$build, 0, 0),
	expense: 0,
	startTime: 0,
	totalBudget: 0,
	totalDays: 0,
...
var author$project$Days$dayDecoder = A3(
	...
	A3(
		...
		elm$json$Json$Decode$succeed(author$project$Days$Day)));
var author$project$Days$makeDays = F3(
	function (before, selected, after) {
		return A3(miyamoen$select_list$SelectList$fromLists, before, selected, after);
	});
var author$project$Days$decoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'after',
	elm$json$Json$Decode$list(author$project$Days$dayDecoder),
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'selected',
		author$project$Days$dayDecoder,
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'before',
			elm$json$Json$Decode$list(author$project$Days$dayDecoder),
			elm$json$Json$Decode$succeed(author$project$Days$makeDays))));
var author$project$Shared$Model = F7(
	function (totalBudget, totalDays, totalSavings, startTime, expense, currentPage, days) {
		return {currentPage: currentPage, days: days, expense: expense, startTime: startTime, totalBudget: totalBudget, totalDays: totalDays, totalSavings: totalSavings};
	});
var author$project$Shared$AddExpense = {$: 'AddExpense'};
...
var author$project$Shared$currentPageDecoder = A2(
	...
	function (str) {
		switch (str) {
			...
			case 'Daily':
				return elm$json$Json$Decode$succeed(author$project$Shared$Daily);
			case 'AddExpense':
				return elm$json$Json$Decode$succeed(author$project$Shared$AddExpense);
			case 'Final':
				return elm$json$Json$Decode$succeed(author$project$Shared$Final);
			case 'Settings':
...
var author$project$Shared$modelDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'days',
	author$project$Days$decoder,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'currentPage',
		author$project$Shared$currentPageDecoder,
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'expense',
			elm$json$Json$Decode$float,
...
var author$project$Main$init = function (initState) {
	var _n0 = A2(elm$json$Json$Decode$decodeValue, author$project$Shared$modelDecoder, initState);
	if (_n0.$ === 'Ok') {
		var savedModel = _n0.a;
		return _Utils_Tuple2(
			savedModel,
			A2(elm$core$Task$perform, author$project$Shared$UpdateDaysLeft, elm$time$Time$now));
	} else {
		var err = _n0.a;
		var _n1 = A2(elm$core$Debug$log, 'err', err);
		return _Utils_Tuple2(author$project$Shared$emptyModel, elm$core$Platform$Cmd$none);
	}
};
...
var author$project$Days$addExpense = F2(
	function (exp, days) {
		return A2(
...
var miyamoen$select_list$Transform$updateAfter = F2(
	function (f, _n0) {
		var before = _n0.a;
		var a = _n0.b;
		var after = _n0.c;
...
var miyamoen$select_list$SelectList$updateAfter = miyamoen$select_list$Transform$updateAfter;
var author$project$Days$setFutures = F2(
	function (day, days) {
		return A2(
			miyamoen$select_list$SelectList$updateAfter,
			elm$core$List$map(
...
var author$project$Days$encodeDay = function (day) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'allowance',
				elm$json$Json$Encode$float(day.allowance)),
				_Utils_Tuple2(
				'transactions',
				A2(elm$json$Json$Encode$list, elm$json$Json$Encode$float, day.transactions))
			]));
};
var miyamoen$select_list$Types$listBefore = function (_n0) {
	var xs = _n0.a;
	return elm$core$List$reverse(xs);
};
var miyamoen$select_list$SelectList$listBefore = miyamoen$select_list$Types$listBefore;
var author$project$Days$encode = function (days) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				A2(
					...
					author$project$Days$encodeDay,
					miyamoen$select_list$SelectList$listBefore(days))),
				_Utils_Tuple2(
				'selected',
				author$project$Days$encodeDay(
					miyamoen$select_list$SelectList$selected(days))),
...
var author$project$Shared$currentPageToString = function (currentPage) {
	switch (currentPage.$) {
		case 'Begin':
			return 'Begin';
		case 'Daily':
...
var author$project$Shared$encodeModel = function (model) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'totalBudget',
				elm$json$Json$Encode$float(model.totalBudget)),
				_Utils_Tuple2(
				'totalDays',
				elm$json$Json$Encode$int(model.totalDays)),
				_Utils_Tuple2(
				'totalSavings',
				elm$json$Json$Encode$float(model.totalSavings)),
				_Utils_Tuple2(
				'startTime',
				elm$json$Json$Encode$int(model.startTime)),
				_Utils_Tuple2(
				'expense',
				elm$json$Json$Encode$float(model.expense)),
				_Utils_Tuple2(
				'currentPage',
				elm$json$Json$Encode$string(
					author$project$Shared$currentPageToString(model.currentPage))),
				_Utils_Tuple2(
				'days',
				author$project$Days$encode(model.days))
			]));
};
var author$project$Main$saveToLocalStorage = function (model) {
	return _Utils_Tuple2(
		model,
		author$project$Main$setStorage(
			author$project$Shared$encodeModel(model)));
};
var author$project$Shared$SetStartTime = function (a) {
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_n0.$) {
			case 'InputBudget':
				var totalBudget = _n0.a;
				var _n1 = elm$core$String$toFloat(totalBudget);
				if (_n1.$ === 'Just') {
					var tb = _n1.a;
			...
			case 'InputTotalDays':
				var days = _n0.a;
				var _n2 = elm$core$String$toInt(days);
				if (_n2.$ === 'Just') {
					var ds = _n2.a;
					return author$project$Main$saveToLocalStorage(
						_Utils_update(
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							days: A2(author$project$Days$build, model.totalDays, model.totalBudget / model.totalDays)
						}),
					A2(elm$core$Task$perform, author$project$Shared$SetStartTime, elm$time$Time$now));
			case 'GotoPage':
				var p = _n0.a;
				return author$project$Main$saveToLocalStorage(
					_Utils_update(
			...
			case 'InputSpend':
				var amt = _n0.a;
				var _n3 = elm$core$String$toFloat(amt);
				if (_n3.$ === 'Just') {
					var exp = _n3.a;
					return author$project$Main$saveToLocalStorage(
						_Utils_update(
			...
			case 'ClickReset':
				return author$project$Main$saveToLocalStorage(author$project$Shared$emptyModel);
			case 'SetStartTime':
				var time = _n0.a;
				return author$project$Main$saveToLocalStorage(
					_Utils_update(
			...
			default:
				...
				if (!model.startTime) {
					...
					return author$project$Main$saveToLocalStorage(
						_Utils_update(
							model,
							{days: newDays, totalSavings: model.totalSavings + savings}));
				}
		}
	});
var author$project$Shared$ClickOk = {$: 'ClickOk'};
var author$project$Shared$InputSpend = function (a) {
	return {$: 'InputSpend', a: a};
};
...
var author$project$Days$toRecord = function (days) {
	return {
		after: miyamoen$select_list$SelectList$listAfter(days),
		before: miyamoen$select_list$SelectList$listBefore(days),
...
var author$project$Ui$pageDaily = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						author$project$Shared$GotoPage(author$project$Shared$AddExpense))
					]),
				_List_fromArray(
					[
						elm$html$Html$text('💵 Spend Money')
					])),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				author$project$Ui$daysView(model.days),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(
						author$project$Shared$GotoPage(author$project$Shared$Settings))
					]),
				_List_fromArray(
					[
...
var author$project$Shared$ClickReset = {$: 'ClickReset'};
var author$project$Ui$pageFinal = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'$' + A2(myrho$elm_round$Round$round, 2, model.totalSavings))
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
